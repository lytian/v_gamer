...
class SystemController extends StatelessWidget {
        ...
        children: <Widget>[
          ...
          _Description(
            ...
            child: _Button(
              ...
              enableLongPress: false,
              onTap: () {
                GameWidget.of(context).game.onBackTap();
              }
            )
          ),
        ],
    ...
    return Material(
      ...
      child: GestureDetector(
        ...
        onTapDown: (_) async {
          ...
          _timer = Timer.periodic(Duration(milliseconds: 60), (t) {
            if (!_tapEnded) {
              widget.onTap();
            } else {
              t.cancel();
  ...
  Widget build(BuildContext context) {
    ...
    switch (direction) {
      case AxisDirection.right:
        widget = Row(
            mainAxisSize: MainAxisSize.min,
            children: <Widget>[child, SizedBox(width: 6), Text(text)]);
        break;
      case AxisDirection.left:
        widget = Row(
          children: <Widget>[Text(text), SizedBox(width: 6), child],
          mainAxisSize: MainAxisSize.min,
        );
        break;
      case AxisDirection.up:
        widget = Column(
          children: <Widget>[Text(text), SizedBox(height: 6), child],
          mainAxisSize: MainAxisSize.min,
        );
        break;
      case AxisDirection.down:
        widget = Column(
          children: <Widget>[child, SizedBox(height: 6), Text(text)],
          mainAxisSize: MainAxisSize.min,
        );
        break;
    }
